                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            <input type="text" className="form-control" name='firstname' onChange={handleChangeInput}
                                   value={firstname}/>
                        </div>

                        <div className="col">
                            <label> last name </label><br/>
                            <input type="text" className="form-control" name='lastname' onChange={handleChangeInput}
                                   value={lastname}/>
                        </div>
                    </div>
                    ...
                    <input className="pass" type="password" name="password" onChange={handleChangeInput}
                           value={password}/>
